...
@rem ##########################################################################
@rem
@rem  ArcGISJava startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and ARC_GIS_JAVA_OPTS to pass JVM options to this script.
...
:fail
rem Set variable ARC_GIS_JAVA_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%ARC_GIS_JAVA_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
