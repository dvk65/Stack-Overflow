This Gradle project extensively uses JavaDocs (because of my professor) which makes it easy to follow. But here is a README to get a basic idea of what it does anyways.
